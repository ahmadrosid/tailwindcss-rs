...
pub fn extract(obj: &'_ Map<String, Value>) -> ConfigValue {
    ...
    utility.insert("overscroll_behavior".into(), extract_object(obj, "overscroll_behavior"));
    utility.insert("box-decoration-break".into(), extract_object(obj, "box-decoration-break"));
    utility
}